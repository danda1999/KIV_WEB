...
class AdministracerecenzentKontroler extends Kontroler
{
    ...
    {
        $this->hlavicka['titulek'] = 'Administrace Recenzent'; //predaný titulek názvu stránky

        $spravceUzivatelu = new SpravceUzivatelu();//tvorba mode SpravceUzivatelu
        ...
        $this->pohled = 'administracerecenzent'; //předá se informace o pohledu a vykreslíse
    }
}
?>